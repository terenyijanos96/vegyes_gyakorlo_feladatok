...
def prime(szam):
    if (szam > 2 and szam % 2 == 0) or szam < 2:  # ezzel gyorsan ki lehet szűrni a 2-nél nagyobb páros számokat,
        return False  # illetve a kettőnél (a legkisebb primszámnál) kisebb számokat
